...
extern char g_doc_gia_ngay_sinh[MAX_SO_LUONG_DOC_GIA * LENGTH_DATE_OF_BIRTH];
extern char g_doc_gia_thang_sinh[MAX_SO_LUONG_DOC_GIA * LENGTH_MONTH_OF_BIRTH];
extern char g_doc_gia_nam_sinh[MAX_SO_LUONG_DOC_GIA * LENGTH_YEAR_OF_BIRTH];
...
extern char g_doc_gia_ngay_lap_the[MAX_SO_LUONG_DOC_GIA * LENGTH_NGAY_LAP_THE];
extern char g_doc_gia_thang_lap_the[MAX_SO_LUONG_DOC_GIA * LENGTH_THANG_LAP_THE];
extern char g_doc_gia_nam_lap_the[MAX_SO_LUONG_DOC_GIA * LENGTH_NAM_LAP_THE];
extern char g_doc_gia_ngay_het_han_the[MAX_SO_LUONG_DOC_GIA * LENGTH_NGAY_HET_HAN_THE];
extern char g_doc_gia_thang_het_han_the[MAX_SO_LUONG_DOC_GIA * LENGTH_THANG_HET_HAN_THE];
extern char g_doc_gia_nam_het_han_the[MAX_SO_LUONG_DOC_GIA * LENGTH_NAM_HET_HAN_THE];
